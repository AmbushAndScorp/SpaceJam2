...
class myApp(ShowBase):
    def __init__(self):
        ...
        self.oasisPlanet = Planet(self.loader, "Assets/Planets/protoPlanet.x", self.render, 'OasisPlanet', "Assets/Planets/Oasis-EQUIRECTANGULAR-7-2048x1024.png", (0, 6000, 0), 300)
        ...
        self.redPlanet = Planet(self.loader, "Assets/Planets/protoPlanet.x", self.render, 'RedPlanet', "Assets/Planets/RedPlanetAnimationClouds.png", (300, 6000, 500), 150)

        self.rockPlanet = Planet(self.loader, "Assets/Planets/protoPlanet.x", self.render, 'RockPlanet', "Assets/Planets/Rock-EQUIRECTANGULAR-15-2048x1024.png", (700, -2000, 100), 500)

        self.savaPlanet = Planet(self.loader, "Assets/Planets/protoPlanet.x", self.render, 'SavaPlanet', "Assets/Planets/Savannah-EQUIRECTANGULAR-7-2048x1024.png", (0, -900, -1400), 700)
